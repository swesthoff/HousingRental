    ...
    <table>
        ...
        <tr>
            <td>Cost</td>
              ...
              <td><fmt:formatNumber value="${u.cost}" type="currency" /></td>
        </tr>
        <tr>
            <td>Deposit Amount</td>
              <td><fmt:formatNumber value="${u.depositAmount}" type="currency" /></td>
        </tr>
        <tr>
      ...
      <br />
       <br />
<a href = "viewAllUnits.mvc">View all Units</a><br /> <br />
